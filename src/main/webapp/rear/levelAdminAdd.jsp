...
window.open(url,"Detail2038154404","Scrollbars=no,Toolbar=no,Location=no,Direction=no,Resizeable=no, Width="+iWidth+" ,Height="+iHeight+",top="+iTop+",left="+iLeft); 
}
...
<input type="hidden" name="g_levelid" value="3">

<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
<tbody><tr class="header"><td colspan="2">新增总代理</td></tr>
