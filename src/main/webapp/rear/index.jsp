...
<iframe frameborder="0" id="header" name="header" src="top.html" scrolling="no" style="height: 65px; visibility: inherit; width: 100%; z-index: 1;"></iframe>
</div>
